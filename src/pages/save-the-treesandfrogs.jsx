...
import './save-the-treesandfrogs.css';

const SaveTheFrogs = () => {
  return (
    <div className="container">
      <div className="center-info">
        <h1 className="company-name"> Trees and Frogs Need Your Help!</h1>
        <img src="\assets\tree_frog.png" className="company-image" alt="treefrog" />
      </div>
      <p className="paragraph">Trees They are good for the diversity of flora and fauna. They give us food, shelter and many more things that we can’t count. Besides, they never demand anything from us and also prevent soil erosion, water evaporation. Above all, they control and manage the effects of wind, sun and, rain. </p>
